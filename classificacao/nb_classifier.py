...
def plotConfusionMatrix(encoderClasses, testEncodedLabels, predictedLabels):
    ...
    metrics.ConfusionMatrixDisplay.from_predictions(
        test, pred, ax=ax, colorbar=False, cmap=plt.cm.Greens
    )
    ...
    plt.savefig(
        r"C:\Users\Pichau\Downloads\Mateus\Desenv\Repositorios\PF-Proc-Img\classificacao\results"
        + getCurrentFileNameAndDateTime(),
        dpi=300,
    )
